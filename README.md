...
This is some old tiny experiment for a reader of scientific articles, abandoned before anything useful.
Pushing it to github if I need it anyway.

Screenshot of current:
![](screen.png)

also there was a sibling dir `article-processorr/` copied in here now.
